...
#define LD_RST_H() 						HAL_GPIO_WritePin(LD3320_RST_GPIO_Port, LD3320_RST_Pin,GPIO_PIN_SET)
#define LD_RST_L() 						HAL_GPIO_WritePin(LD3320_RST_GPIO_Port, LD3320_RST_Pin, GPIO_PIN_RESET)

#define LD_CS_H()						HAL_GPIO_WritePin(LD3320_CS_GPIO_Port, LD3320_CS_Pin,GPIO_PIN_SET)
#define LD_CS_L()						HAL_GPIO_WritePin(LD3320_CS_GPIO_Port, LD3320_CS_Pin,GPIO_PIN_RESET)

#define LD_SPIS_H()  					HAL_GPIO_WritePin(LD3320_WR_GPIO_Port, LD3320_WR_Pin,GPIO_PIN_SET)
#define LD_SPIS_L()  					HAL_GPIO_WritePin(LD3320_WR_GPIO_Port, LD3320_WR_Pin,GPIO_PIN_RESET)
